...
describe('MoneyCalculator', () => {
  describe('add', () => {
    ...
    it('should handle single value', () => {
      const result = MoneyCalculator.add(100.5);
  ...
  describe('subtract', () => {
    it('should subtract two values correctly', () => {
      const result = MoneyCalculator.subtract(100.5, 50.25);
  ...
  describe('multiply', () => {
    ...
    it('should multiply by one', () => {
      const result = MoneyCalculator.multiply(100.5, 1);
      expect(result).toBe(100.5);
    });
  ...
  describe('divide', () => {
    ...
    it('should handle division by one', () => {
      const result = MoneyCalculator.divide(100.5, 1);
      expect(result).toBe(100.5);
    });
  ...
  describe('splitEqually', () => {
    ...
    it('should throw error for zero parts', () => {
      expect(() => MoneyCalculator.splitEqually(100, 0)).toThrow(
        'Number of parts must be positive'
      );
    });

    it('should throw error for negative parts', () => {
      expect(() => MoneyCalculator.splitEqually(100, -3)).toThrow(
        'Number of parts must be positive'
      );
    });
  ...
  describe('equals', () => {
    it('should return true for equal values', () => {
      expect(MoneyCalculator.equals(100.5, 100.5)).toBe(true);
    });

    it('should return false for different values', () => {
      expect(MoneyCalculator.equals(100.5, 100.51)).toBe(false);
    });
  ...
  describe('format', () => {
    ...
    it('should format small values', () => {
      const formatted = MoneyCalculator.format(0.5);
      expect(formatted).toBeTruthy();
    });
  });
});
